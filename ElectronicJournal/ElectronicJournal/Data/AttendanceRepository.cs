...
namespace ElectronicJournal.Data
{
    public class AttendanceRepository : IAttendanceRepository
    {
        ...
        public List<Attendance> GetAll() => _attendances.ToList();
        public Attendance GetById(int id) => _attendances.FirstOrDefault(a => a.Id == id);
        ...
        {
            var a = GetById(id);
            if (a != null) _attendances.Remove(a);
        }

        public List<Attendance> GetByStudent(int studentId) => _attendances.Where(a => a.StudentId == studentId).ToList();
        public List<Attendance> GetByDate(DateTime date) => _attendances.Where(a => a.Date.Date == date.Date).ToList();
    }
}