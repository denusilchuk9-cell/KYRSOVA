...
namespace ElectronicJournal.Business
{
    public class GradeCalculator
    {
        ...
        public double CalculateAverageByStudent(List<Grade> grades, int studentId) => _strategy.Calculate(grades.Where(g => g.StudentId == studentId).ToList());
        public double CalculateAverageBySubject(List<Grade> grades, int subjectId) => _strategy.Calculate(grades.Where(g => g.SubjectId == subjectId).ToList());
